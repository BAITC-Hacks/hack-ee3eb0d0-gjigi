...
| AI-агент | OpenAI API, function calling (10 инструментов + обязательное объяснение каждого шага); запасной режим — агент на правилах |
...
| ICON недоступен | 0.173 | 0.169 | 0.170 | 0 / 10 (пропуск модель переносит сама) |
| ECMWF 9 км (главный источник) недоступен | 0.211 | 0.205 | 0.203 | 0 / 10 (прогноз продолжается на 3 моделях) |
