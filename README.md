...
| Проверка | pytest (17 тестов), `make verify` (побитовое воспроизведение февраля) |
...
2. **Прогнать тесты:** `make test` — 17 тестов: очистка данных, **отсутствие утечки** (удаление всех будущих прогонов
